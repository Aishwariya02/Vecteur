...
{
    return sqrt(V1[0]**2+V1[1]**2+V2[2]**2);
}
...
void Vector::direction_cosine()
{
    ...
    cout<<"("<<this.V[0]<<"/"<<mag<<","<<this.V[1]<<"/"<<mag<<","<<this.V2[2]<<"/"<<mag<<")";
}
...
{
    Vector res;
    res[0] = this.V[1] * V1.V[2] - this.V[2] * V1.V[1];
    res[1] = -(this.V[0] * V1.V[2] - this.V[2] * V1.V[0]);
    res[2] = this.V[0] * V1.V[1] - this.V[1] * V1.V[0];
    return res;
}
Vector Vector::scalarMultiple()
{
    ...
    cin>>scalar;
    Vector res;
    res[0] = this.V[0]*scalar;
    res[1] = this.V[1]*scalar;
    res[2] = this.V[2]*scalar;
    return res;
}
